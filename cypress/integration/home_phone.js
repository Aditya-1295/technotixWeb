describe('Tests for title section', ()=>{
    it('Checks URL for main page for phone resolution i-phone 6',()=>{
        cy.viewport('iphone-6')
        cy.visit("http://localhost:3000").url().should('include', '/')
        
    })

    it('Checks all the components for text content in Navigation bar for phone resolution i-phone 6', ()=>{
        cy.viewport('iphone-6')
        cy.get('body > section#title > div > nav.navbar > a.navbar-brand').should('have.text' , 'Technotix BU')
        cy.getNavItem_first().should('not.be.visible')
        cy.getNavItem_second().should('not.be.visible')
        cy.getNavItem_third().should('not.be.visible')
        cy.getNavItem_fourth().should('not.be.visible')
        cy.getNavItem_fifth().should('not.be.visible')
        cy.getNavToggler().should('be.visible').click()
    })

    it('Clicks all the navigation bar links to check  scrolling by button for respective sections for phone resolution i-phone 6', ()=>{
        cy.viewport('iphone-6')
...
describe('Tests for ABOUT section', ()=>{
    it('Checks the title and content for about section for phone resolution i-phone 6', ()=>{
        cy.viewport('iphone-6')
...
describe('Tests for EVENT section', ()=>{
    it('Checks the title for EVENT section for phone resolution i-phone 6', ()=>{
        cy.viewport('iphone-6')
    ...
    it('Checks for EVENT-Caraousel for phone resolution i-phone 6', ()=>{
        cy.getSection_event().within(()=>{
            cy.viewport('iphone-6')
...
describe('Tests for Project section ', ()=>{
    it('Checks the title for Project section for phone resolution i-phone 6', ()=>{
        cy.viewport('iphone-6')
    ...
    it('Checks for Project-Caraousel for phone resolution i-phone 6', ()=>{
        cy.getSection_project().within(()=>{
            cy.viewport('iphone-6')
            cy.log('This is before clicking the next button for changing carousel item')
            cy.getCard_first().should('be.visible')
...
describe('Tests for Our Team section ', ()=>{
    it('Checks the title for Team section for phone resolution i-phone 6', ()=>{
        cy.viewport('iphone-6')
    ...
    it('Checks for button content and herf tag for phone resolution i-phone 6', ()=>{
        cy.viewport('iphone-6')
        cy.getSection_team().within(()=>{
...
describe('Tests for Contact Form section', ()=>{
    ...
    it('Checks the title for  contact form section for phone resolution i-phone 6', ()=>{
        cy.viewport('iphone-6')
    ...
    it('Fills up the Contact form and checks for the API response (Node Mailer) for phone resolution i-phone 6', ()=>{
        cy.viewport('iphone-6')
        cy.getSection_contact().within(()=>{
...
describe('Tests for Contact Footer section', ()=>{
    it('Footer content testing for phone resolution i-phone 6',()=>{
        cy.viewport('iphone-6')
        cy.getFooter().within(()=>{
